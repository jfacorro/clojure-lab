...
(def syntax {
  :special-form {:style {:bold false :foreground {:r 200, :g 0, :b 200}}}
  :var          {:style {:bold false :foreground {:r 0, :g 255, :b 255}}}
  :symbol       {:style {:bold false :foreground {:r 100, :g 220, :b 179}}}
  :delimiter    {:style {:bold false :foreground {:r 255, :g 255, :b 255}}}
  :accesor      {:style {:bold false :foreground {:r 150, :g 0, :b 0}}}
  :regex        {:style {:bold false :foreground {:r 223 :g 100, :b 67}}}
  :keyword      {:style {:bold false :foreground {:r 0, :g 255, :b 0}}}
  :namespace    {:style {:bold false :foreground {:r 150, :g 0, :b 0}}}
  :string       {:style {:bold false :foreground {:r 230 :g 29, :b 67}}}
